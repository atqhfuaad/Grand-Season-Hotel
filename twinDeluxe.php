...
<section class="service-sec" id="benefits">
  <div class="container">
    <div class="row">
			...
			<div class="row">
				<div class="container">
				  <div class="mySlides">
				    ...
				    <img src="hotel_image/room/twin_deluxe/twin_deluxe1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">2 / 5</div>
				    <img src="hotel_image/room/twin_deluxe/twin_deluxe2.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">3 / 5</div>
				    <img src="hotel_image/room/twin_deluxe/twin_deluxe3.jpg" style="width:100%">
				  </div>
				    
				  <div class="mySlides">
				    <div class="numbertext">4 / 5</div>
				    <img src="hotel_image/room/twin_deluxe/twin_deluxe4.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">5 / 5</div>
				    <img src="hotel_image/room/twin_deluxe/twin_deluxe5.jpg" style="width:100%">
				  </div>
				  ...
				  <div class="row">
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/twin_deluxe/twin_deluxe1.jpg" style="width:100%" onclick="currentSlide(1)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/twin_deluxe/twin_deluxe2.jpg" style="width:100%" onclick="currentSlide(2)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/twin_deluxe/twin_deluxe3.jpg" style="width:100%" onclick="currentSlide(3)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/twin_deluxe/twin_deluxe4.jpg" style="width:100%" onclick="currentSlide(4)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/twin_deluxe/twin_deluxe5.jpg" style="width:100%" onclick="currentSlide(5)">
				    </div>    
				  </div>
				</div>
				<br>
		...
		<div class="col-md-4">
			<p style="font-size:20px; text-decoration: line-through; color:grey;"><b>RM 330</b></p>
			<p style="font-size:20px; color:red;"><b>RM </b><b style="font-size:35px">297</b></p><br><br>
			<h3>Room details :</h3>
			<p style="font-size:17px"><i class="material-icons">visibility</i>  City view<br>
			   <i class="material-icons">home</i>  29 m²/312 ft²<br>
			   <i class="material-icons">account_balance</i>  Balcony / terrace<br>
			   <i class="material-icons">smoke_free</i>  Non-smoking<br>
			   <i class="material-icons">ac_unit</i>  Air-conditioning<br>
			   <i class="material-icons">hotel</i>  2 single beds<br>
		...
		<br>
			...
			<h3>Benefits :</h3>
			<p style="font-size:17px"><i class="material-icons">restaurant</i>  Breakfast purchased separately<br>
			   <i class="material-icons">wifi</i>  Free Wi-Fi<br>
		...
		<br>
			<h3>Discounts :</h3>
			<p style="font-size:17px"><i class="material-icons">local_offer</i>  Instant discount : RM 33<br>
