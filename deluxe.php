...
<section class="service-sec" id="benefits">
    ...
    <div class="row">
			...
			<div class="row">
				<div class="container">
				  <div class="mySlides">
				    ...
				    <img src="hotel_image/room/deluxe/deluxe1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">2 / 5</div>
				    <img src="hotel_image/room/deluxe/deluxe2.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">3 / 5</div>
				    <img src="hotel_image/room/deluxe/deluxe3.jpg" style="width:100%">
				  </div>
				    
				  <div class="mySlides">
				    <div class="numbertext">4 / 5</div>
				    <img src="hotel_image/room/deluxe/deluxe4.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">5 / 5</div>
				    <img src="hotel_image/room/deluxe/deluxe5.jpg" style="width:100%">
				  </div>
				  ...
				  <div class="row">
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/deluxe/deluxe1.jpg" style="width:100%" onclick="currentSlide(1)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/deluxe/deluxe2.jpg" style="width:100%" onclick="currentSlide(2)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/deluxe/deluxe3.jpg" style="width:100%" onclick="currentSlide(3)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/deluxe/deluxe4.jpg" style="width:100%" onclick="currentSlide(4)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/deluxe/deluxe5.jpg" style="width:100%" onclick="currentSlide(5)">
				    </div>    
				  </div>
				</div>
				<br>
		...
		<div class="col-md-4">
			<p style="font-size:20px; text-decoration: line-through; color:grey;"><b>RM 280</b></p>
			<p style="font-size:20px; color:red;"><b>RM </b><b style="font-size:35px">260</b></p><br><br>
			<h3>Room details :</h3>
		...
		<br>
			<h3>Discounts :</h3>
			<p style="font-size:17px"><i class="material-icons">local_offer</i>  Instant discount : RM 20<br></p>		
		</div>
    </div>
    <!-- /.row --> 
	</div>
