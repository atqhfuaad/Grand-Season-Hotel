    ...
    <div class="row">
        <div class="col-md-12">
            <div class="heading">
				...
				<h2 align="left">Premier Deluxe</h2>
				<?php if (isset($_SESSION["is_login"])):?>
			...
			<div class="row">
				<div class="container">
				  <div class="mySlides">
				    ...
				    <img src="hotel_image/room/premier_deluxe/premier_deluxe1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">2 / 7</div>
				    <img src="hotel_image/room/premier_deluxe/premier_deluxe2.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">3 / 7</div>
				    <img src="hotel_image/room/premier_deluxe/premier_deluxe3.jpg" style="width:100%">
				  </div>
				    
				  <div class="mySlides">
				    <div class="numbertext">4 / 7</div>
				    <img src="hotel_image/room/premier_deluxe/premier_deluxe4.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">5 / 7</div>
				    <img src="hotel_image/room/premier_deluxe/premier_deluxe5.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">6 / 7</div>
				    <img src="hotel_image/room/premier_deluxe/premier_deluxe6.jpg" style="width:100%">
				  </div>

				  <div class="mySlides">
				    <div class="numbertext">7 / 7</div>
				    <img src="hotel_image/room/premier_deluxe/premier_deluxe7.jpg" style="width:100%">
				  </div>
				  ...
				  <div class="row">
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/premier_deluxe/premier_deluxe1.jpg" style="width:100%" onclick="currentSlide(1)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/premier_deluxe/premier_deluxe2.jpg" style="width:100%" onclick="currentSlide(2)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/premier_deluxe/premier_deluxe3.jpg" style="width:100%" onclick="currentSlide(3)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/premier_deluxe/premier_deluxe4.jpg" style="width:100%" onclick="currentSlide(4)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/premier_deluxe/premier_deluxe5.jpg" style="width:100%" onclick="currentSlide(5)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/premier_deluxe/premier_deluxe6.jpg" style="width:100%" onclick="currentSlide(5)">
				    </div>
				    <div class="column">
				      <img class="demo cursor" src="hotel_image/room/premier_deluxe/premier_deluxe7.jpg" style="width:100%" onclick="currentSlide(5)">
				    </div>
				  </div>
				</div>
				<br>
		...
		<div class="col-md-4">
			<p style="font-size:20px; text-decoration: line-through; color:grey;"><b>RM 350</b></p>
			<p style="font-size:20px; color:red;"><b>RM </b><b style="font-size:35px">318</b></p><br><br>
			<h3>Room details :</h3>
			<p style="font-size:17px"><i class="material-icons">visibility</i>  City view<br>
			   <i class="material-icons">home</i>  26 m²/280 ft²<br>
			   <i class="material-icons">smoke_free</i>  Non-smoking<br>
			   <i class="material-icons">ac_unit</i>  Air-conditioning<br>
			   <i class="material-icons">hotel</i>  1 king bed<br>
		...
		<br><br><br>
			...
			<p style="font-size:17px"><i class="material-icons">payment</i>  Pay at the hotel<br>
			   ...
			   <i class="material-icons">wifi</i>  Free Wi-Fi<br>
			   <i class="material-icons">grade</i>  Extra low price! ( non-refundable )<br>
			   <i class="material-icons">warning</i>  Maximum 2 adults<br>
			   <i class="material-icons">accessibility_new</i><i class="material-icons">accessibility_new</i>
			   Children younger than 12 years old are NOT ALLOWED to stay in this room.<br>
			   If you are travelling with children, please check other rooms.
			</p>
		<br><br>
			<h3>Discounts :</h3>
			<p style="font-size:17px"><i class="material-icons">local_offer</i>  Instant discount : RM 32<br>
