      ...
      <a class="navbar-brand mx-auto" href="#">Grand Seasons</a>
       <div class="collapse navbar-collapse" id="navbarCollapse1">
        <ul class="navbar-nav ml-auto">
			...
			<li class="nav-item active"> <a class="nav-link" href="facilities.php #benefits">Facilities</a></li>
...
<div class="swiper-container main-slider" id="myCarousel">
  <div class="swiper-wrapper">
    <div class="swiper-slide slider-bg-position" style="background:url('hotel_image/view.jpg')" data-hash="slide1">
      <h2>The ideal choice among hotels in Kuala Lumpur for businessman and tourist </h2>
    </div>
  </div>  
</div>
...
<section class="service-sec" id="benefits">
  <div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="heading">
				<h1 align="left" style="color:black">Facilities</h1><br>
				<h2 align="left">Exterior View</h2>
			</div>
        </div>
		<div class="col-md-8">
			<div class="row">
				<div class="slideshow-container">
				  <div class="mySlides8">
				    <img src="hotel_image/exterior/exterior_view1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides8">
				    <img src="hotel_image/exterior/exterior_view2.jpg" style="width:100%">
				  </div>
...
<section class="service-sec" id="benefits">
  <div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="heading">
				<h2 align="left">Interior View</h2>
			</div>
        </div>
		<div class="col-md-8">
			<div class="row">
				<div class="slideshow-container">
				  <div class="mySlides7">
				    <img src="hotel_image/interior/ballroom.jpg" style="width:100%">
				  </div>

				  <div class="mySlides7">
				    <img src="hotel_image/interior/corridor.jpg" style="width:100%">
				  </div>

				  <div class="mySlides7">
				    <img src="hotel_image/interior/entrance.jpg" style="width:100%">
				  </div>

				  <div class="mySlides7">
				    <img src="hotel_image/interior/interior_view1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides7">
				    <img src="hotel_image/interior/interior_view2.jpg" style="width:100%">
				  </div>

				  <div class="mySlides7">
				    <img src="hotel_image/interior/interior_view3.jpg" style="width:100%">
				  </div>

				  <div class="mySlides7">
				    <img src="hotel_image/interior/interior_view4.jpg" style="width:100%">
				  </div>

				  <div class="mySlides7">
				    <img src="hotel_image/interior/interior_view5.jpg" style="width:100%">
				  </div>

				  <div class="mySlides7">
				    <img src="hotel_image/interior/lobby1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides7">
				    <img src="hotel_image/interior/lobby2.jpg" style="width:100%">
				  </div>

				  <div class="mySlides7">
				    <img src="hotel_image/interior/reception.jpg" style="width:100%">
				  </div>				  
...
<section class="service-sec" id="benefits">
  <div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="heading">
				<h2 align="left">Fitness Center</h2>
			</div>
        </div>
		<div class="col-md-8">
			<div class="row">
				<div class="slideshow-container">
				  <div class="mySlides1">
				    <img src="hotel_image/fitness/fitness_center1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides1">
				    <img src="hotel_image/fitness/fitness_center2.jpg" style="width:100%">
				  </div>

				  <div class="mySlides1">
				    <img src="hotel_image/fitness/fitness_center3.jpg" style="width:100%">
				  </div>
...
<section class="service-sec" id="benefits">
  <div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="heading">
				<h2 align="left">Business Center</h2>
			</div>
        </div>
		<div class="col-md-8">
			<div class="row">
				<div class="slideshow-container">
				  <div class="mySlides4">
				    <img src="hotel_image/business_center/business_center1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides4">
				    <img src="hotel_image/business_center/business_center2.jpg" style="width:100%">
				  </div>
    ...
    <div class="row">
		...
		<div class="col-md-8">
			<div class="row">
				<div class="slideshow-container">
				  <div class="mySlides2">
				    <img src="hotel_image/bar/bar1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides2">
				    <img src="hotel_image/bar/bar2.jpg" style="width:100%">
				  </div>

				  <div class="mySlides2">
				    <img src="hotel_image/bar/bar3.jpg" style="width:100%">
				  </div>

				  <div class="mySlides2">
				    <img src="hotel_image/bar/bar4.jpg" style="width:100%">
				  </div>

				  <div class="mySlides2">
				    <img src="hotel_image/bar/bar5.jpg" style="width:100%">
				  </div>

				  <div class="mySlides2">
				    <img src="hotel_image/bar/bar6.jpg" style="width:100%">
				  </div>

				  <div class="mySlides2">
				    <img src="hotel_image/bar/bar7.jpg" style="width:100%">
				  </div>

				  <div class="mySlides2">
				    <img src="hotel_image/bar/bar8.jpg" style="width:100%">
				  </div>
    ...
    <div class="row">
		...
		<div class="col-md-8">
			<div class="row">
				<div class="slideshow-container">
				  <div class="mySlides5">
				    <img src="hotel_image/lounge/lounge1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides5">
				    <img src="hotel_image/lounge/lounge2.jpg" style="width:100%">
				  </div>
    ...
    <div class="row">
		...
		<div class="col-md-8">
			<div class="row">
				<div class="slideshow-container">
				  <div class="mySlides3">
				    <img src="hotel_image/coffee_shop/coffee_shop1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides3">
				    <img src="hotel_image/coffee_shop/coffee_shop2.jpg" style="width:100%">
				  </div>

				  <div class="mySlides3">
				    <img src="hotel_image/coffee_shop/coffee_shop3.jpg" style="width:100%">
				  </div>

				  <div class="mySlides3">
				    <img src="hotel_image/coffee_shop/coffee_shop4.jpg" style="width:100%">
				  </div>

				  <div class="mySlides3">
				    <img src="hotel_image/coffee_shop/coffee_shop5.jpg" style="width:100%">
				  </div>

				  <div class="mySlides3">
				    <img src="hotel_image/coffee_shop/coffee_shop6.jpg" style="width:100%">
				  </div>

				  <div class="mySlides3">
				    <img src="hotel_image/coffee_shop/coffee_shop7.jpg" style="width:100%">
				  </div>

				  <div class="mySlides3">
				    <img src="hotel_image/coffee_shop/coffee_shop8.jpg" style="width:100%">
				  </div>

				  <div class="mySlides3">
				    <img src="hotel_image/coffee_shop/coffee_shop9.jpg" style="width:100%">
				  </div>
    ...
    <div class="row">
		...
		<div class="col-md-8">
			<div class="row">
				<div class="slideshow-container">
				  <div class="mySlides6">
				    <img src="hotel_image/restaurant/restaurant1.jpg" style="width:100%">
				  </div>

				  <div class="mySlides6">
				    <img src="hotel_image/restaurant/restaurant2.jpg" style="width:100%">
				  </div>

				  <div class="mySlides6">
				    <img src="hotel_image/restaurant/restaurant3.jpg" style="width:100%">
				  </div>

				  <div class="mySlides6">
				    <img src="hotel_image/restaurant/restaurant4.jpg" style="width:100%">
				  </div>

				  <div class="mySlides6">
				    <img src="hotel_image/restaurant/restaurant5.jpg" style="width:100%">
				  </div>
