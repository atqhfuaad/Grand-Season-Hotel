    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse1">
        <ul class="navbar-nav ml-auto">
			...
			<li class="nav-item"> <a class="nav-link" href="#benefits">Accommodation</a> </li>
			<li class="nav-item"https://s.bootsnipp.com/iframe/NjR9z#blog> <a class="nav-link" href="#about">About</a> </li>
...
<section class="service-sec" id="benefits">
  <div class="container">
    <div class="row">
        <div class="col-md-12">
            <div class="heading">
			  <h2 style="color:blue">Room Choices<small>4 room types with 20 total room offers available.</h2>
			  <?php if (isset($_SESSION["is_login"])):?>
			  <br><h2><a href="bookingForm.php" style="color:red; font-size:30px;"><b> Book Now ! </b></a></small></h2>
			  <?php else :?>
			  <br><h2><a href="login.php" style="color:red; font-size:30px;"><b> Book Now ! </b></a></small></h2>
			  <?php endif;?>
			</div>
        </div>
      <div class="col-md-8">
        <div class="row">
          ...
          <h3><a href="deluxe.php #benefits" style="color:purple">Deluxe</a></h3>
          <p style="font-size:17px; text-decoration: line-through; color:grey;"><b>RM 280</b></p>
		  <p style="font-size:17px; color:red;"><b>RM </b><b style="font-size:25px">260</b></p>
        </div>
        <div class="col-md-6 text-sm-center service-block"> <i class="fa fa-leaf" aria-hidden="true"></i>
          <h3><a href="twinDeluxe.php #benefits" style="color:purple">Twin Deluxe</a></h3>
          <p style="font-size:17px; text-decoration: line-through; color:grey;"><b>RM 330</b></p>
		  <p style="font-size:17px; color:red;"><b>RM </b><b style="font-size:25px">297</b></p>
        </div>
        <div class="col-md-6 text-sm-center service-block"> <i class="fa fa-leaf" aria-hidden="true"></i>
          <h3><a href="grandDeluxe.php #benefits" style="color:purple">Grand Deluxe</a></h3>
          <p style="font-size:17px; text-decoration: line-through; color:grey;"><b>RM 379</b></p>
		  <p style="font-size:17px; color:red;"><b>RM </b><b style="font-size:25px">355</b></p>
        </div>
        <div class="col-md-6 text-sm-center service-block"> <i class="fa fa-leaf" aria-hidden="true"></i>
          <h3><a href="premierDeluxe.php #benefits" style="color:purple">Premier Deluxe</a></h3>
          <p style="font-size:17px; text-decoration: line-through; color:grey;"><b>RM 350</b></p>
		  <p style="font-size:17px; color:red;"><b>RM </b><b style="font-size:25px">318</b></p>
        </div>
        </div>
      </div>
      <div class="col-md-4"> <img src="hotel_image/interior/lobby1.jpg" class="img-fluid" /> </div>
    </div>
    <!-- /.row --> 
  </div>
</section>
...
<section class="about-sec parallax-section" id="about">
  <div class="container">
    <div class="row">
      <div class="col-md-3">
        <h2>About<br>Our Hotel</h2>
      </div>
      <div class="col-md-6">
		<p style="line-height:1.6"> Grand Seasons Hotel, among the premier business hotel in Kuala Lumpur, the economic capital of Malaysia is 
		characterised by the traditionally hospitality located in the heart of the city. </p>
		<p>The ideal choice  among hotels in Kuala Lumpur for businessman and tourist. </p>
		<p style="font-size:18px"><i class="material-icons">favorite_border</i><b>  Things you'll love :</b>			
		<p><i class="material-icons">train</i>  270 meters to public transportation</p>
		<p><i class="material-icons">flight</i>  Airport shuttle</p>
		<p><i class="material-icons">ac_unit</i>  Air-conditioning</p>
		<p><i class="material-icons">wifi</i>  Free Wi-Fi in all rooms</p>
		<p><i class="material-icons">hot_tub</i>  Hot tub</p>
		<p><i class="material-icons">fitness_center</i>  Fitness center</p>
		<p><i class="material-icons">local_cafe</i>  Coffee shop</p>
		<p><i class="material-icons">local_bar</i>  Bar</p>
		<p><i class="material-icons">pool</i>  Swimming pool</p>
		<p><i class="material-icons">meeting_room</i>  Business center</p>
		<p><i class="material-icons">room_service</i>  Room services</p>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="row">
	  ...
	  <br><br><br><br>
		...
		<b style="font-size:18px">For any enquiries, please kindly contact us :</b><br>	
		<i class="material-icons">call</i>  Contact Number : 017 - 751 2203 / 016 - 738 3790<br>
		<i class="material-icons">local_printshop</i>  Fax : 03-5403992<br>
		<i class="material-icons">email</i>  Email : grandseasonskl@gmail.com<br>
		<i class="material-icons">place</i>  Address : 72,Jalan Pahang, Chowkit/ Putra WTC, Kuala Lumpur, Malaysia.</p>
      </div>
    </div>
  </div>
</section>
